...
if __name__ == "__main__":
    ...
    wordcatcodeFile = "/Users/tdong/data/glove_wordSenseCatCode57285.txt.newest.clean"
    WS_CHILDREN_GLOVE6B = '/Users/tdong/data/glove_wordSenseChildren57285.txt.newest.clean'
    # glove.6B.children.txt glove.6B.children.train

    # outputRoot = "/Users/tdong/data/glove/glove.6B/"
    outputRoot = "/Users/tdong/data/glove/"

    outputPath = os.path.join(outputRoot, "balls")
    outputForestPath = os.path.join(outputRoot, "ball_backup")
    outputBallFile = os.path.join(outputRoot, "nball_57285.txt")
    outputCentrePath = os.path.join(outputRoot, "glove.6B.50Xball.Center")

    logFile = os.path.join(outputRoot, "glove.6B.50Xball.100.17_10.512.100.forest.log")


    word2vecFile = "/Users/tdong/data/glove/glove.6B.50d.txt"
    taxoPathFile = "/Users/tdong/data/glove/wordSensePath.txt"
    wordcatcodeFile = "/Users/tdong/data/glove/glove.6B.catcode.txt"
    WS_CHILDREN_GLOVE6B = '/Users/tdong/data/glove/wordSenseChildren47634.txt'
    outputPath = "/Users/tdong/data/glove/data_out47634/balls"
    outputPathBack = "/Users/tdong/data/glove/data_out47634/balls_backup"


    wsChildrenDic, word2vecDic, wscatCodeDic = initialize_dictionaries(word2vecFile=word2vecFile,
                                                                       catDicFile=wordcatcodeFile,
                                                                       wsChildrenFile=WS_CHILDREN_GLOVE6B)
    ...
    train_word2ball(root="*root*", outputPath=outputPath, wsChildrenDic=wsChildrenDic,
                    ...
                    word2ballDic=dict(), outputPathBack=None,
                    outputBallFile=outputBallFile)


    # maxsize, mindim, word2ballDic = load_balls(ipath=outputPath, word2ballDic=dict())
    # fix_dim(maxsize, mindim, bPath=outputPath)
    # copy_tree("/Users/tdong/data/glove/balls", "/Users/tdong/data/glove/ball_backup")
    # make_DC_for_first_level_children(root="*root*", firstChild='entity.n.01', wsChildrenDic=wsChildrenDic,
    #                                  word2ballDic=word2ballDic, outputPath=outputPath,
    #                                  maxsize=maxsize, mindim=mindim, logFile=logFile)
